...
class Ui_ScanFrame(object):
    def setupUi(self, ScanFrame):
        ...
        self.laxian_name_input = QLineEdit(self.frame_2)
        self.laxian_name_input.setObjectName(u"laxian_name_input")
        self.laxian_name_input.setFocusPolicy(Qt.NoFocus)
        self.laxian_name_input.setReadOnly(True)

        self.gridLayout.addWidget(self.laxian_name_input, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.banzu_name_input, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.user_name_input, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.task_count_input, 0, 3, 1, 1)
        ...
        self.label.setBuddy(self.laxian_name_input)
        ...
        QWidget.setTabOrder(self.order_no_input, self.banzu_name_input)
        QWidget.setTabOrder(self.banzu_name_input, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.pushButton)
        QWidget.setTabOrder(self.pushButton, self.laxian_name_input)
        QWidget.setTabOrder(self.laxian_name_input, self.task_count_input)
        QWidget.setTabOrder(self.task_count_input, self.user_name_input)
        QWidget.setTabOrder(self.user_name_input, self.cus_order_no_input)
    ...
    def retranslateUi(self, ScanFrame):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("ScanFrame", u"\u62c9\u7ebf", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("ScanFrame", u"\u73ed\u7ec4", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("ScanFrame", u"\u626b\u7801\u65f6\u95f4", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("ScanFrame", u"\u64cd\u4f5c\u4eba", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("ScanFrame", u"\u4ea7\u54c1\u7801", None));
        ___qtablewidgetitem6 = self.tableWidget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("ScanFrame", u"\u7bb1\u7801", None));
        ___qtablewidgetitem7 = self.tableWidget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("ScanFrame", u"\u5361\u677f\u7801", None));
        ___qtablewidgetitem8 = self.tableWidget.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("ScanFrame", u"\u4e0a\u4f20\u72b6\u6001", None));
        ___qtablewidgetitem9 = self.tableWidget.horizontalHeaderItem(9)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("ScanFrame", u"\u4e0a\u4f20\u4eba", None));
        ___qtablewidgetitem10 = self.tableWidget.horizontalHeaderItem(10)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("ScanFrame", u"\u4e0a\u4f20\u65f6\u95f4", None));
        ...
        self.label.setText(QCoreApplication.translate("ScanFrame", u"\u62c9\u7ebf\uff1a", None))
        ...
        self.label_9.setText(QCoreApplication.translate("ScanFrame", u"\u626b\u63cf\u4ea7\u54c1", None))
    # retranslateUi
